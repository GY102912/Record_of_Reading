...
class UserProvider extends ChangeNotifier {
  ...
  // 사용자 정보 가져오기
  Future<User?> getUser(String userId, String userName) async {
    ...
    if (userSnapshot.exists) {
      ...
      User? xuser = await createUserWithEmptyUser(userId, userName);
      if (xuser != null) {
        _user = xuser;
        notifyListeners();
      }
  ...
  Future<User> createUserWithEmptyUser(String userId, String userName) async {
    // 빈 유저 객체 생성
    User user = User(
      userId: userId,
      userName: userName,
  ...
  Future<void> createUserWithBooks(User user) async {
    // 사용자 문서 생성
